...
\begin{itemize}
    ...
    \item \textbf{Revisione e valutazione}, perché un prodotto entri in \textbf{baseline\ap{G}}, le modifiche apportate devono essere prima verificate da un \textbf{verificatore\ap{G}} (si veda Sezione ?) e successivamente revisionate dal \textbf{responsabile\ap{G}}. Quest’ultimo accerta che i prodotti software e i piani risultino conformi ai requisiti stabiliti, valutando l’esito dei compiti completati e garantendo qualità e coerenza con gli obiettivi del processo.
