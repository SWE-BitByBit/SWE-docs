...
\hline
\rowcolor{white}
Studio delle metriche per la qualità da inserire nel cruscotto &  VE RTB 3.3\\
\hline
\rowcolor{gray!20}
Bozza per gli scenari da insierire nel documento AdR &  VI RTB 3.4 \\
\hline
\rowcolor{white}
Sistemazione del \textbf{repository\ap{G}} per la visualizzazione corretta dell'ordine dei documenti &  VE RTB 3.5\\
\hline
\end{tabular}
\end{center}
